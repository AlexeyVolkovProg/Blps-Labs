...
public class VideoController {
    ...
    public ResponseEntity<Void> fileComplaint(@RequestBody ComplaintCreateRequestDTO complaintDTO) {
        videoService.createComplaint(complaintDTO);
    ...
    public ResponseEntity<Void> moderateVideo(@PathVariable UUID videoId, @RequestParam boolean approve) {
        videoService.moderateVideo(videoId, approve);
